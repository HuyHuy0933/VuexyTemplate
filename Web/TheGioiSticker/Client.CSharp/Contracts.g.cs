...
namespace Example.Api.Client.CSharp.Contracts
{
    ...
    public partial interface ICategoryClient
    {
        ...
        System.Threading.Tasks.Task<FileResponse> CreateCategoryAsync(CreateCategoryInput input);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<FileResponse> CreateCategoryAsync(CreateCategoryInput input, System.Threading.CancellationToken cancellationToken);
    
    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class CreateCategoryInput 
    {
        ...
        public static CreateCategoryInput FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CreateCategoryInput>(data);
        }
